    ...
    <div class="main student">
        ...
        <div class="search">
            <form class="d-flex" role="search">
                    <input class="form-control me-2" type="search" placeholder="Veuillez renseigner votre filtre" aria-label="Veuillez renseigner votre filtre">
                    <button class="btn btn-outline-danger" type="submit">Filtrer</button>
            </form>
...
<?php
include '../fragments/tableEtudiants.php';
?>
