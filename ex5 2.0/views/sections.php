...
<body>
   ...
   <div class="main student">
       <div class="alert alert-secondary" role="alert">
        ...
        <br>
        <?php
        include_once '../fragments/exportbtns.php'; ?>
        <div class="container mt-2">
            <table class="table table-striped display" id = "studentsTable">
                ...
                <?php foreach($sections as $section): ?>
                    <tr>
                        <td scope="row"><?= htmlspecialchars($section->id) ?></td>
                        <td scope="row"><?= htmlspecialchars($section->designation) ?></td>
                        <td scope="row"><?= htmlspecialchars($section->description) ?></td>
                        <td scope="row">
