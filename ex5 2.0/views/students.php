...
include '../fragments/header.php';?>
   ...
   <div class="main student">
       ...
       <div class="search">
           ...
           <form class="d-flex" role="search" method = "get" action="../actions/searchStudent_action.php">
                ...
                <button class="btn btn-outline-danger" type="submit" name = "search">Filtrer</button>
           </form>
